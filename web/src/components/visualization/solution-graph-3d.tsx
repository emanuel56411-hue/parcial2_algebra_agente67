...
const colors = ["#49d7aa", "#f5be55", "#ef8799"]
...
export default function SolutionGraph3D({ report }: { report: Analysis }) {
  ...
  return <div className="overflow-hidden rounded-xl border bg-[#101e1b]">
    ...
    <p className="px-4 py-3 text-xs text-muted-foreground">Arrastra para rotar · verde, ámbar y rosa: planos 1–3{solution ? " · punto blanco: intersección" : " · sin punto de intersección única"}.</p>
  </div>
}
