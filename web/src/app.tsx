          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="grid gap-5 xl:grid-cols-[19rem_minmax(0,1fr)]">
              <Card className="h-fit"><CardHeader><CardTitle className="text-lg">Configuración</CardTitle><CardDescription>Origen, escenario y método principal.</CardDescription></CardHeader><CardContent className="space-y-5">
                ...
                {source === "scenario" && <div className="rounded-lg border border-primary/20 bg-primary/5 p-3 text-xs leading-relaxed"><p className="font-bold uppercase tracking-[.14em] text-primary">Mapa de las 4 pruebas</p><ol className="mt-2 space-y-1 text-muted-foreground"><li><strong className="text-foreground">1.</strong> Vector esperado (escenario).</li><li><strong className="text-foreground">2.</strong> Sustitución directa y E &lt; 10⁻⁶ (automática al resolver).</li><li><strong className="text-foreground">3.</strong> Escasez con B₃ = 100 (escenario).</li><li><strong className="text-foreground">4.</strong> Singularidad: cero o infinitas soluciones (dos escenarios).</li></ol></div>}
