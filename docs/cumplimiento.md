...
| Capturas de la web | `scripts/browser_check.py`, `docs/screenshots/`, `docs/logs/browser.json` | 7 comprobaciones de navegador aprobadas; 8 capturas reales de escritorio y móvil |
