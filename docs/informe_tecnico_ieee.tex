...
\scriptsize Fila 1: (2)\(\cdot\)(15) + (1)\(\cdot\)(20) + (3)\(\cdot\)(25) + (1)\(\cdot\)(10) + (2)\(\cdot\)(15) + (1)\(\cdot\)(20) = 185; B1 = 185; |AX - B| = 0\\

Fila 2: (1)\(\cdot\)(15) + (3)\(\cdot\)(20) + (2)\(\cdot\)(25) + (2)\(\cdot\)(10) + (1)\(\cdot\)(15) + (2)\(\cdot\)(20) = 200; B2 = 200; |AX - B| = 0\\

Fila 3: (3)\(\cdot\)(15) + (2)\(\cdot\)(20) + (4)\(\cdot\)(25) + (1)\(\cdot\)(10) + (3)\(\cdot\)(15) + (2)\(\cdot\)(20) = 280; B3 = 280; |AX - B| = 0\\

Fila 4: (1)\(\cdot\)(15) + (1)\(\cdot\)(20) + (1)\(\cdot\)(25) + (4)\(\cdot\)(10) + (2)\(\cdot\)(15) + (1)\(\cdot\)(20) = 150; B4 = 150; |AX - B| = 0\\

Fila 5: (2)\(\cdot\)(15) + (1)\(\cdot\)(20) + (2)\(\cdot\)(25) + (1)\(\cdot\)(10) + (5)\(\cdot\)(15) + (3)\(\cdot\)(20) = 245; B5 = 245; |AX - B| = 0\\

Fila 6: (1)\(\cdot\)(15) + (2)\(\cdot\)(20) + (1)\(\cdot\)(25) + (2)\(\cdot\)(10) + (1)\(\cdot\)(15) + (4)\(\cdot\)(20) = 195; B6 = 195; |AX - B| = 0\\\normalsize
...
Se resuelve U\(\cdot\)X = C desde la última fila hacia la primera.
...
\medskip
\subsection*{Paso 39: [I | X]: lectura de la solución}
...
Producto fila por columna en X = A-¹\(\cdot\)B.
