...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(theme_toggle).to_have_attribute("aria-label", "Activar modo oscuro")
        theme_toggle.click()
        expect(page.locator("html")).to_have_attribute("data-theme", "dark")
        expect(theme_toggle).to_have_attribute("aria-label", "Activar modo claro")
        page.wait_for_timeout(300)
        page.screenshot(path=str(output / "13_vercel_oscuro.png"), full_page=False)
        page.reload(wait_until="networkidle")
        expect(page.locator("html")).to_have_attribute("data-theme", "dark")
